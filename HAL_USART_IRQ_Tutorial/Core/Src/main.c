...
int main(void)
{
  ...
  //enable the uart recive and transmit functions
...
void HAL_UART_TxCptCallback(UART_HandleTypeDef *huart2)
{
//	memset(user_data,0,strlen(user_data));
}

// write the callback method
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart2)
{
	...
	//code for if we wanted to implement a buffer and send a longer message
	// this could be included as extra material if the member wants
//	if (recvd_data == '\r') {
//		data_buffer[count++]='\n';
